...
public class CashierForm extends javax.swing.JFrame {
        ...
        txtKodeBarang.getDocument().addDocumentListener(new javax.swing.event.DocumentListener() {
            ...
            public void insertUpdate(DocumentEvent arg0) {               
                 switch(txtKodeBarang.getText()){
                    ...
                    case "A002" -> {
                        txtNamaBarang.setText(minyakGoreng.getNamaBarang());
                        txtHargaBarang.setText(nf.format(beras.getHargaBarang()));
                        // Kursor akan fokus ke QTY
                        txtQTY.grabFocus();
                    }
                    case "A003" -> {
                        txtNamaBarang.setText(gula.getNamaBarang());
                        txtHargaBarang.setText(nf.format(gula.getHargaBarang()));
                        // Kursor akan fokus ke QTY
                        txtQTY.grabFocus();
                    }
                    default -> {
    ...
    private void jmlTotalHarga(int subTotal) {
